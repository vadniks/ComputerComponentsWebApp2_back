...
// TODO: use the client's uuid, which will be generated by the client side (flutter) and will be supplied here with request
// TODO: or don't use token at all as cookie data is encrypted anyway
// TODO: delete session data when the same user logs in again or don't use user entity to store token as with sessionStorageDatabase it will be stored in the database anyway
...
fun Application.configureSecurity() {
    ...
    install(Sessions) {
        cookie<UserIdPrincipal>(COOKIE, SessionStorageDatabase()/*SessionStorageMemory()*/) {
